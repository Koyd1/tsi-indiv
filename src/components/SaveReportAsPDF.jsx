...
//     pdf.addImage(imgData, 'png', 0, yOffset, imageWidth, imageHeight);
//
//     // Теперь будем добавлять страницы, если изображение больше одной страницы
//     while (yOffset + imageHeight < canvasHeight) {
//       yOffset += imageHeight; // Перемещаемся вниз на одну страницу
//       pdf.addPage(); // Добавляем новую страницу
//       pdf.addImage(imgData, 'png', 0, -yOffset, imageWidth, imageHeight); // Добавляем фрагмент изображения
//     }
//
//     // Сохраняем PDF
//     pdf.save('report.pdf');
